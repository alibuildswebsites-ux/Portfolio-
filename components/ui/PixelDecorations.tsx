...
export const PixelCloud = memo(({ size = "w-32", className = "", duration = 25, delay = 0, top = "10%" }: { size?: string, className?: string, duration?: number, delay?: number, top?: string }) => (
  ...
  >
    <svg viewBox="0 0 32 20" className="w-full h-full pixel-antialiased" shapeRendering="crispEdges">
       {/* Border Layer (Bluish Pastel) - Added for better visibility */}
       <g fill="#B0C4DE">
         {/* Top Borders */}
...
export const PixelComputerAvatar = memo(() => {
  return (
    <div className="relative w-48 h-48 sm:w-72 sm:h-72 md:w-80 md:h-80 lg:w-96 lg:h-96 shrink-0 max-w-full transition-all duration-300">
      {/* Floating Status Window - INCREASED SIZE */}
      <motion.div
        initial={{ y: 5 }}
        animate={{ y: -5 }}
      ...
      <svg viewBox="0 0 64 64" className="w-full h-full pixel-antialiased drop-shadow-xl" shapeRendering="crispEdges">
        ...
        {/* --- COMPUTER SETUP --- */}
        {/* Desk */}
        <rect x="8" y="54" width="48" height="2" fill="#8D6E63" /> 
        <rect x="10" y="56" width="4" height="8" fill="#6D4C41" /> 
        <rect x="50" y="56" width="4" height="8" fill="#6D4C41" /> 

        {/* Laptop */}
        <rect x="22" y="52" width="20" height="2" fill="#424242" /> 
        <rect x="23" y="40" width="18" height="12" fill="#616161" /> 
        <rect x="24" y="41" width="16" height="10" fill="#2D2D2D" /> 
        ...
        <g transform="translate(48, 48)">
           ...
           <rect x="0" y="4" width="1" height="1" fill="#795548" /> 
        </g>
        
        {/* Table Legs - Added Explicitly */}
        <rect x="8" y="62" width="8" height="2" fill="#5D4037" />
        <rect x="48" y="62" width="8" height="2" fill="#5D4037" />
